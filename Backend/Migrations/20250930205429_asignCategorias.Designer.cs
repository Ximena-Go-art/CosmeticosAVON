...
namespace Backend.Migrations
{
    ...
    [Migration("20250930205429_asignCategorias")]
    partial class asignCategorias
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Service.Models.Venta", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Estado = 2,
                            Fecha = new DateTime(2025, 9, 30, 17, 54, 27, 315, DateTimeKind.Local).AddTicks(8326),
                            IsDeleted = false,
                            Nombre = "",
                            PrecioTotal = 150.00m
                        },
                        new
                        {
                            Id = 2,
                            Estado = 1,
                            Fecha = new DateTime(2025, 9, 30, 17, 54, 27, 315, DateTimeKind.Local).AddTicks(8335),
                            IsDeleted = false,
                            Nombre = "",
                            PrecioTotal = 200.00m
                        },
                        new
                        {
                            Id = 3,
                            Estado = 3,
                            Fecha = new DateTime(2025, 9, 30, 17, 54, 27, 315, DateTimeKind.Local).AddTicks(8338),
                            IsDeleted = false,
                            Nombre = "",
                            PrecioTotal = 300.00m
                        },
                        new
                        {
                            Id = 4,
                            Estado = 2,
                            Fecha = new DateTime(2025, 9, 30, 17, 54, 27, 315, DateTimeKind.Local).AddTicks(8341),
                            IsDeleted = false,
                            Nombre = "",
                            PrecioTotal = 400.00m
                        },
                        new
                        {
                            Id = 5,
                            Estado = 1,
                            Fecha = new DateTime(2025, 9, 30, 17, 54, 27, 315, DateTimeKind.Local).AddTicks(8346),
                            IsDeleted = false,
                            Nombre = "",
                            PrecioTotal = 500.00m
                        });
