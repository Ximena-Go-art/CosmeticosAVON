...
namespace Backend.Migrations
{
    ...
    [Migration("20250924220455_PruebaPrecios")]
    partial class PruebaPrecios
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Service.Models.Venta", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Estado = 2,
                            Fecha = new DateTime(2025, 9, 24, 19, 4, 51, 621, DateTimeKind.Local).AddTicks(9416),
                            IsDeleted = false,
                            Nombre = "",
                            PrecioTotal = 150.00m
                        },
                        new
                        {
                            Id = 2,
                            Estado = 1,
                            Fecha = new DateTime(2025, 9, 24, 19, 4, 51, 621, DateTimeKind.Local).AddTicks(9426),
                            IsDeleted = false,
                            Nombre = "",
                            PrecioTotal = 200.00m
                        },
                        new
                        {
                            Id = 3,
                            Estado = 3,
                            Fecha = new DateTime(2025, 9, 24, 19, 4, 51, 621, DateTimeKind.Local).AddTicks(9429),
                            IsDeleted = false,
                            Nombre = "",
                            PrecioTotal = 300.00m
                        },
                        new
                        {
                            Id = 4,
                            Estado = 2,
                            Fecha = new DateTime(2025, 9, 24, 19, 4, 51, 621, DateTimeKind.Local).AddTicks(9432),
                            IsDeleted = false,
                            Nombre = "",
                            PrecioTotal = 400.00m
                        },
                        new
                        {
                            Id = 5,
                            Estado = 1,
                            Fecha = new DateTime(2025, 9, 24, 19, 4, 51, 621, DateTimeKind.Local).AddTicks(9435),
                            IsDeleted = false,
                            Nombre = "",
                            PrecioTotal = 500.00m
                        });
