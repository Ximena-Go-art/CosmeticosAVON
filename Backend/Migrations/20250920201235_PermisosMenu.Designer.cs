...
namespace Backend.Migrations
{
    ...
    [Migration("20250920201235_PermisosMenu")]
    partial class PermisosMenu
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Service.Models.Venta", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Estado = 2,
                            Fecha = new DateTime(2025, 9, 20, 17, 12, 32, 969, DateTimeKind.Local).AddTicks(2746),
                            IsDeleted = false,
                            Nombre = "",
                            PrecioTotal = 150.00m
                        },
                        new
                        {
                            Id = 2,
                            Estado = 1,
                            Fecha = new DateTime(2025, 9, 20, 17, 12, 32, 969, DateTimeKind.Local).AddTicks(2759),
                            IsDeleted = false,
                            Nombre = "",
                            PrecioTotal = 200.00m
                        },
                        new
                        {
                            Id = 3,
                            Estado = 3,
                            Fecha = new DateTime(2025, 9, 20, 17, 12, 32, 969, DateTimeKind.Local).AddTicks(2762),
                            IsDeleted = false,
                            Nombre = "",
                            PrecioTotal = 300.00m
                        },
                        new
                        {
                            Id = 4,
                            Estado = 2,
                            Fecha = new DateTime(2025, 9, 20, 17, 12, 32, 969, DateTimeKind.Local).AddTicks(2765),
                            IsDeleted = false,
                            Nombre = "",
                            PrecioTotal = 400.00m
                        },
                        new
                        {
                            Id = 5,
                            Estado = 1,
                            Fecha = new DateTime(2025, 9, 20, 17, 12, 32, 969, DateTimeKind.Local).AddTicks(2768),
                            IsDeleted = false,
                            Nombre = "",
                            PrecioTotal = 500.00m
                        });
