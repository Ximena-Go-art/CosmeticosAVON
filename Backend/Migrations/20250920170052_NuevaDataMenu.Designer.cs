...
namespace Backend.Migrations
{
    ...
    [Migration("20250920170052_NuevaDataMenu")]
    partial class NuevaDataMenu
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Service.Models.Venta", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Estado = 2,
                            Fecha = new DateTime(2025, 9, 20, 14, 0, 50, 218, DateTimeKind.Local).AddTicks(310),
                            IsDeleted = false,
                            Nombre = "",
                            PrecioTotal = 150.00m
                        },
                        new
                        {
                            Id = 2,
                            Estado = 1,
                            Fecha = new DateTime(2025, 9, 20, 14, 0, 50, 218, DateTimeKind.Local).AddTicks(319),
                            IsDeleted = false,
                            Nombre = "",
                            PrecioTotal = 200.00m
                        },
                        new
                        {
                            Id = 3,
                            Estado = 3,
                            Fecha = new DateTime(2025, 9, 20, 14, 0, 50, 218, DateTimeKind.Local).AddTicks(322),
                            IsDeleted = false,
                            Nombre = "",
                            PrecioTotal = 300.00m
                        },
                        new
                        {
                            Id = 4,
                            Estado = 2,
                            Fecha = new DateTime(2025, 9, 20, 14, 0, 50, 218, DateTimeKind.Local).AddTicks(325),
                            IsDeleted = false,
                            Nombre = "",
                            PrecioTotal = 400.00m
                        },
                        new
                        {
                            Id = 5,
                            Estado = 1,
                            Fecha = new DateTime(2025, 9, 20, 14, 0, 50, 218, DateTimeKind.Local).AddTicks(328),
                            IsDeleted = false,
                            Nombre = "",
                            PrecioTotal = 500.00m
                        });
