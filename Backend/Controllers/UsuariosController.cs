...
namespace Backend.Controllers
{
    ...
    public class UsuariosController : ControllerBase
    {
        ...
        public UsuariosController(CosmeticosContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<IEnumerable<Usuario>>> GetCapacitacionesDeleteds()
        {
        ...
        // RESTORE: api/Usuarios/restore/5  ESTE
        [HttpPut("restore/{id}")]
